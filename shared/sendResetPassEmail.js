...
function sendResetPassEmail(pin, user) {
    ...
    let transporter = nodemailer.createTransport({
        ...
        auth: {
            user: 'spectoraofficial@gmail.com', // generated ethereal user
            pass: 'spectora123'  // generated ethereal password
        },
        tls: {
    ...
    let mailOptions = {
        from: '"Spectora" <spectoraofficial@gmail.com>', // sender address
        to: [user.email], // list of receivers
        subject: 'SPECTORA Support', // Subject line
